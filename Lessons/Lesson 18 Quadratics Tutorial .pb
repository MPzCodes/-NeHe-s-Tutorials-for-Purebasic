;NeHe & TipTup's Quadratics Tutorial (Lesson 18)
;http://nehe.gamedev.net 
;https://nehe.gamedev.net/tutorial/quadrics/20001/
...
Global sp.b ;Spacebar Pressed? ( NEW )

Global part1.l ;Start Of Disc ( NEW )
Global part2.l ;End Of Disc ( NEW )
Global p1.l=0 ;Increase 1 ( NEW )
Global p2.l=1 ;Increase 2 ( NEW )
...
Global quadratic.i ;Storage For Our Quadratic Objects ( NEW )
...
Global object.l=0 ;Which Object To Draw ( NEW )
...
Procedure InitGL() ;All Setup For OpenGL Goes Here
  ...
  quadratic=gluNewQuadric_() ;Create A Pointer To The Quadric Object, returns 0 if failed ( NEW )
  gluQuadricNormals_(quadratic,#GLU_SMOOTH) ;Create Smooth Normals ( NEW )
  gluQuadricTexture_(quadratic,#GL_TRUE) ;Create Texture Coords ( NEW )
...
Procedure glDrawCube() ;Draw A Cube
  ...
  ;Front Face
  glNormal3f_( 0.0, 0.0, 1.0) ;Normal Facing Towards
  ...
  ;Back Face
  glNormal3f_( 0.0, 0.0,-1.0) ;Normal Facing Away
  glTexCoord2f_(1.0, 0.0) : glVertex3f_(-1.0,-1.0,-1.0) ;Bottom Right Of The Texture and Quad
  glTexCoord2f_(1.0, 1.0) : glVertex3f_(-1.0, 1.0,-1.0) ;Top Right Of The Texture and Quad
  glTexCoord2f_(0.0, 1.0) : glVertex3f_( 1.0, 1.0,-1.0) ;Top Left Of The Texture and Quad
  glTexCoord2f_(0.0, 0.0) : glVertex3f_( 1.0,-1.0,-1.0) ;Bottom Left Of The Texture and Quad
  ;Top Face
  glNormal3f_( 0.0, 1.0, 0.0) ;Normal Facing Up
  glTexCoord2f_(0.0, 1.0) : glVertex3f_(-1.0, 1.0,-1.0) ;Top Left Of The Texture and Quad
  glTexCoord2f_(0.0, 0.0) : glVertex3f_(-1.0, 1.0, 1.0) ;Bottom Left Of The Texture and Quad
  glTexCoord2f_(1.0, 0.0) : glVertex3f_( 1.0, 1.0, 1.0) ;Bottom Right Of The Texture and Quad
  glTexCoord2f_(1.0, 1.0) : glVertex3f_( 1.0, 1.0,-1.0) ;Top Right Of The Texture and Quad
  ;Bottom Face
  glNormal3f_( 0.0,-1.0, 0.0) ;Normal Facing Down
  glTexCoord2f_(1.0, 1.0) : glVertex3f_(-1.0,-1.0,-1.0) ;Top Right Of The Texture and Quad
  glTexCoord2f_(0.0, 1.0) : glVertex3f_( 1.0,-1.0,-1.0) ;Top Left Of The Texture and Quad
  glTexCoord2f_(0.0, 0.0) : glVertex3f_( 1.0,-1.0, 1.0) ;Bottom Left Of The Texture and Quad
  glTexCoord2f_(1.0, 0.0) : glVertex3f_(-1.0,-1.0, 1.0) ;Bottom Right Of The Texture and Quad
  ;Right Face
  glNormal3f_( 1.0, 0.0, 0.0) ;Normal Facing Right
  glTexCoord2f_(1.0, 0.0) : glVertex3f_( 1.0,-1.0,-1.0) ;Bottom Right Of The Texture and Quad
  glTexCoord2f_(1.0, 1.0) : glVertex3f_( 1.0, 1.0,-1.0) ;Top Right Of The Texture and Quad
  glTexCoord2f_(0.0, 1.0) : glVertex3f_( 1.0, 1.0, 1.0) ;Top Left Of The Texture and Quad
  glTexCoord2f_(0.0, 0.0) : glVertex3f_( 1.0,-1.0, 1.0) ;Bottom Left Of The Texture and Quad
  ;Left Face
  glNormal3f_(-1.0, 0.0, 0.0) ;Normal Facing Left
  glTexCoord2f_(0.0, 0.0) : glVertex3f_(-1.0,-1.0,-1.0) ;Bottom Left Of The Texture and Quad
  glTexCoord2f_(1.0, 0.0) : glVertex3f_(-1.0,-1.0, 1.0) ;Bottom Right Of The Texture and Quad
  glTexCoord2f_(1.0, 1.0) : glVertex3f_(-1.0, 1.0, 1.0) ;Top Right Of The Texture and Quad
  glTexCoord2f_(0.0, 1.0) : glVertex3f_(-1.0, 1.0,-1.0) ;Top Left Of The Texture and Quad
...
Procedure DrawScene(Gadget)
  ...
  Select object ;Check object To Find Out What To Draw
    ...
    Case 2 ;Drawing Object 3
      gluDisk_(quadratic,0.5,1.5,32,32) ;Draw A Disc (CD Shape) With Inner Radius Of 0.5 And Outer Radius Of 1.5 Plus A Lot Of Segments ;)
    ...
    Case 5 ;Drawing Object 6
      ...
      EndIf
      gluPartialDisk_(quadratic,0.5,1.5,32,32,part1,part2-part1) ;A Disk Like The One Before
...
CreateGLWindow("NeHe & TipTup's Quadratics Tutorial (Lesson 18)",640,480,16,0)

InitGL()

LoadGLTextures(#PB_Compiler_Home + "examples/3d/Data/Textures/Geebee2.bmp")
;LoadGLTextures("Data/Wall.bmp"); -> Original from http://nehe.gamedev.net
