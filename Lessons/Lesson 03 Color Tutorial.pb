;NeHe's Adding Colour Tutorial (Lesson 3) 
;http://nehe.gamedev.net 
;https://nehe.gamedev.net/tutorial/adding_colour/13003/
...
Procedure DrawScene(Gadget)
  ...
  glBegin_(#GL_TRIANGLES);
    glColor3f_(1.0,0.0,0.0);          // Set The Color To Red// Drawing Using Triangles
  ...
  glColor3f_(0.5,0.5,1.0);              // Set The Color To Blue One Time Only
...
CreateGLWindow("OpenGL Lesson 3",640,480,16,0)
